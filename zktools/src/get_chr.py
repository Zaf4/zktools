# Python code to download a chromosome of the human genome from https://ftp.ensembl.org/pub/release-110/fasta/homo_sapiens/dna/Homo_sapiens.GRCh38.dna.chromosome.{chr}.fa.gz
...
def download_chr(chr_folder:os.PathLike="./",
                 chr:int|str=17,
                 release:int|str=109,
                 build:int=38,
                 species:str="human",
    ...
    Args:
        chr_folder (os.PathLike, optional): 
            Path to the folder where the chromosome file will be saved. Defaults to "work dir".
        chr (int|str, optional): 
            Chromosome number or identifier.
            Defaults to 17.
        release (int|str, optional): 
            Release version of the genome.
            Defaults to 109.
        build (int, optional):
            Build version of the genome.
            Defaults to 38.
